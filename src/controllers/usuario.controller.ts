...
import {ResetearClave} from '../models/resetear-clave.model';
...
export class UsuarioController {
  ...
  async create(
    ...
    if (usuarioCreado) {
      let contenido = `Hola! Tu registro ha sido un exito, tus credenciales de acceso son |Usuario|: ${usuarioCreado.nombre_usuario} - |Contraseña|: ${claveAleatoria}`;
